...
public class marbleGameFinal extends connectAll {
	...
	private ImageIcon evenButtonDefault = new ImageIcon(marbleGameFinal.class.getResource("../img/evenButton.png"));
	private ImageIcon evenButtonEntered = new ImageIcon(
			marbleGameFinal.class.getResource("../img/evenButtonEntered.png"));
	private ImageIcon oddButtonDefault = new ImageIcon(marbleGameFinal.class.getResource("../img/oddButton.png"));
	private ImageIcon oddButtonEntered = new ImageIcon(marbleGameFinal.class.getResource("../img/oddButtonEntered.png"));
	...
	public marbleGameFinal(String pNum) {
		super(pNum);
		panJf.dispose();
